...
public abstract class BaseTripleValueSpanParticleModifier extends BaseDoubleValueSpanParticleModifier {
	...
	protected abstract void onSetValues(final Particle pParticle, final float pPercentageDone, final float pValueA, final float pValueB, final float pValueC);
	...
	@Override
	protected void onSetValues(final Particle pParticle, final float pPercentageDone, final float pValueA, final float pValueB) {
