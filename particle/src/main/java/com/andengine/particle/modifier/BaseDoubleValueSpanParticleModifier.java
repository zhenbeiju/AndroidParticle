...
public abstract class BaseDoubleValueSpanParticleModifier extends BaseSingleValueSpanParticleModifier {
	...
	protected abstract void onSetValues(final Particle pParticle, final float pPercentageDone, final float pValueA, final float pValueB);
	...
	@Override
	protected void onSetValue(final Particle pParticle, final float pPercentageDone, final float pValueA) {
